    ...
    switch (NAV_MODE.nav_mode)
    {
        ...
        case NAV_MODE.CAM_TARGET:
        {
            ...
            else
            {
                ...
                current_goal.velocity.x = 0.3*pid_calculate(x_error, kp, ki, kd, max_speed, integral, prev_error, dt ); 
                current_goal.velocity.y = 0.3*pid_calculate(y_error, kp, ki, kd, max_speed, integral, prev_error, dt ); 
